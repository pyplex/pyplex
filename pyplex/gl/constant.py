...
class SamplerParameter(IntEnum):
    MAG_FILTER = 0x2800
    MIN_FILTER = 0x2801
...
class UniformParameter(IntEnum):
    UNIFORM_TYPE = 0x8A37
    UNIFORM_SIZE = 0x8A38
...
class UniformBlockParameter(IntEnum):
...
class AtomicCounterParameter(IntEnum):
