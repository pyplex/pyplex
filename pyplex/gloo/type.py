...
class Type:
    ...
    _GL_UNIFORM = {
        # TODO: Find appropriate uniform function for float16
        gl.Type.HALF_FLOAT: None,

        gl.Type.FLOAT: gl.Context.uniform_1fv,
        gl.Type.FLOAT_VEC2: gl.Context.uniform_2fv,
        gl.Type.FLOAT_VEC3: gl.Context.uniform_3fv,
        gl.Type.FLOAT_VEC4: gl.Context.uniform_4fv,

        gl.Type.DOUBLE: gl.Context.uniform_1dv,
        gl.Type.DOUBLE_VEC2: gl.Context.uniform_2dv,
        gl.Type.DOUBLE_VEC3: gl.Context.uniform_3dv,
        gl.Type.DOUBLE_VEC4: gl.Context.uniform_4dv,

        gl.Type.INT: gl.Context.uniform_1iv,
        gl.Type.INT_VEC2: gl.Context.uniform_2iv,
        gl.Type.INT_VEC3: gl.Context.uniform_3iv,
        gl.Type.INT_VEC4: gl.Context.uniform_4iv,

        gl.Type.UNSIGNED_INT: gl.Context.uniform_1uiv,
        gl.Type.UNSIGNED_INT_VEC2: gl.Context.uniform_2uiv,
        gl.Type.UNSIGNED_INT_VEC3: gl.Context.uniform_3uiv,
        gl.Type.UNSIGNED_INT_VEC4: gl.Context.uniform_4uiv,

        gl.Type.BOOL: gl.Context.uniform_1iv,
        gl.Type.BOOL_VEC2: gl.Context.uniform_2iv,
        gl.Type.BOOL_VEC3: gl.Context.uniform_3iv,
        gl.Type.BOOL_VEC4: gl.Context.uniform_4iv,

        gl.Type.FLOAT_MAT2: gl.Context.uniform_matrix_2fv,
        gl.Type.FLOAT_MAT3: gl.Context.uniform_matrix_3fv,
        gl.Type.FLOAT_MAT4: gl.Context.uniform_matrix_4fv,
        gl.Type.FLOAT_MAT2x3: gl.Context.uniform_matrix_2x3fv,
        gl.Type.FLOAT_MAT2x4: gl.Context.uniform_matrix_2x4fv,
        gl.Type.FLOAT_MAT3x4: gl.Context.uniform_matrix_3x4fv,
        gl.Type.FLOAT_MAT4x2: gl.Context.uniform_matrix_4x2fv,
        gl.Type.FLOAT_MAT4x3: gl.Context.uniform_matrix_4x3fv,

        gl.Type.DOUBLE_MAT2: gl.Context.uniform_matrix_2dv,
        gl.Type.DOUBLE_MAT3: gl.Context.uniform_matrix_3dv,
        gl.Type.DOUBLE_MAT4: gl.Context.uniform_matrix_4dv,
        gl.Type.DOUBLE_MAT2x3: gl.Context.uniform_matrix_2x3dv,
        gl.Type.DOUBLE_MAT2x4: gl.Context.uniform_matrix_2x4dv,
        gl.Type.DOUBLE_MAT3x4: gl.Context.uniform_matrix_3x4dv,
        gl.Type.DOUBLE_MAT4x2: gl.Context.uniform_matrix_4x2dv,
        gl.Type.DOUBLE_MAT4x3: gl.Context.uniform_matrix_4x3dv,
    }
    ...
    @property
    def uniform_func(self) -> Callable[[gl.Program, int, np.ndarray], None]:
        """
